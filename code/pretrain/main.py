...
from modifiedTorchDiffEqPack.odesolver import odesolve
...
#     val_list=[0]
    ...
    if pretrain:
        ...
        optimizer = optim.Adam(
            [
                {'params': front_net_crnn.parameters(),'lr':5e-7,'momentum':0.9},
                {'params': back_net_crnn.parameters(),'lr':5e-7,'momentum':0.9},
